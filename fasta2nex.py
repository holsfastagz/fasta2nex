...
candidate_orfs = [longest_record[i:].translate(
    to_stop=True) for i in range(3, len(longest_record))]
...
nexus_pos1 = "charset " + gene_name + "pos1" + " = " + \
    str(begin_pos) + "-" + str(end_pos1) + "\\3;\n"
nexus_pos2 = "charset " + gene_name + "pos2" + " = " + \
    str(begin_pos + 1) + "-" + str(end_pos2) + "\\3;\n"
nexus_pos3 = "charset " + gene_name + "pos3" + " = " + \
    str(begin_pos + 2) + "-" + str(end_pos3) + "\\3;\n"

nexus_header = "\n\n#NEXUS\n\n\nbegin sets;\n"
nexus_footer = "end;"

bottom_nexus_file = nexus_header + nexus_pos1 + \
    nexus_pos2 + nexus_pos3 + nexus_footer
